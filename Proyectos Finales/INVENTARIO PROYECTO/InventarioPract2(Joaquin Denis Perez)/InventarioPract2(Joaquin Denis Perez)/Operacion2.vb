...
Public Class Operacion2
    ...
    Private Sub Operacion2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        Try
            ...
            cmd.Connection = cnn
            sql = "DELETE FROM inventario.repuestos WHERE ID = ('" + txtID.Text + " ') OR 
            Ubicac = ('" + txtUbica.Text + " ')"

            cmd.CommandText = sql
            result = cmd.ExecuteNonQuery()
            If result > 0 Then
                MessageBox.Show("Eliminado con Éxito", "Guardado")

            End If
        Catch ex As Exception
            MessageBox.Show("Se Eliminó Correctamente el Repuesto")
        End Try
        cnn.Close()
    End Sub
